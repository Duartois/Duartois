...
export default function Navbar() {
  ...
  const [areControlsVisible, setAreControlsVisible] =
    useState(shouldShowControls);
  const [areControlsActive, setAreControlsActive] =
    useState(shouldShowControls);
              ...
              >
                ...
                >
                  ...
                  <path
                    ...
                    strokeWidth={11}
                  />
                  <circle cx="170.984" cy="165" r="34" strokeWidth={11} />
                </svg>
              </Link>
            </div>
